...
# json file (update karna bhulna nhi) 
...
while True:
    ...
    if faceCurFrame:
        ...
        if counter != 0:
            if counter == 1:
                ...
                studentInfo = all_students.get(id)
    ...
    cv2.imshow("Face Attendance", imgBackground)
    cv2.waitKey(1)
# done hogya sab # wala htana he thik se nhi likha he bhulna nhi he 